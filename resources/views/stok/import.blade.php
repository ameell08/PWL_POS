    ...
    $(document).ready(function() {
        $("#form-import-stok").validate({
            ...
            submitHandler: function(form) {
                ...
                form); // Convert form to FormData to handle file uploads 
                $.ajax({
                    url: form.action,
                    type: form.method,
                    data: formData, // Send FormData 
                    processData: false, // Set processData and contentType to false to handle files 
                    contentType: false,
                    success: function(response) {
                        if (response.status) { // If successful 
                            ...
                            dataStok.ajax
                        .reload(); // Reload datatable (assuming a datatable is used) 
