@extends('layouts.template') @section('content') <div class="card card-outline card-primary">
	...
	<div class="card-body"> @empty($level) <div class="alert alert-danger alert-dismissible">
			<h5>
		...
		</table> @endempty <a href="{{ url('level') }}" class="btn btn-sm btn-default mt-2">Kembali</a>
	</div>
